...
_STR: dict[str, dict[str, str]] = {
    ...
    "btn.apply": {"en-US": "Apply", "pt-BR": "Aplicar"},
    ...
    "ga.hud.keys": {"en-US": "space=play/pause  g=+1gen  t=turbo  a=apply  h=tutorial",
                    "pt-BR": "space=play/pause  g=+1ger  t=turbo  a=aplicar  h=tutorial"},
    "ga.hint.apply": {"en-US": "* unapplied slider changes - click Apply",
                      "pt-BR": "* mudancas nao aplicadas - clique Aplicar"},
    ...
    "dqn.hud.keys": {"en-US": "space=play/pause  t=turbo  a=apply  h=tutorial",
                     "pt-BR": "space=play/pause  t=turbo  a=aplicar  h=tutorial"},
    "dqn.hint.apply": {"en-US": "* unapplied slider changes - click Apply",
                       "pt-BR": "* mudancas nao aplicadas - clique Aplicar"},
